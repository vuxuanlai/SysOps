...
if cpu_usage_percent >= cmd_options.critical_per:
    print cmd_options.cpu_name +' STATISTICS CRITICAL :cpu=%.2f%% user=%.2f%% system=%.2f%% iowait=%.2f%% steal=%.2f%% | cpu=%.2f%% user=%.2f system=%.2f iowait=%.2f steal=%.2f' % (cpu_usage_percent, cpu_user_usage_percent, cpu_system_usage_percent, cpu_iowait_usage_percent, cpu_steal_time_usage_percent,cpu_usage_percent, cpu_user_usage_percent, cpu_system_usage_percent, cpu_iowait_usage_percent, cpu_steal_time_usage_percent)
    sys.exit(2)
elif  cpu_usage_percent >= cmd_options.warning_per:
    print cmd_options.cpu_name +' STATISTICS WARNING :cpu=%.2f%% user=%.2f%% system=%.2f%% iowait=%.2f%% steal=%.2f%% | cpu=%.2f%% user=%.2f system=%.2f iowait=%.2f steal=%.2f' % (cpu_usage_percent, cpu_user_usage_percent, cpu_system_usage_percent, cpu_iowait_usage_percent, cpu_steal_time_usage_percent, cpu_usage_percent, cpu_user_usage_percent, cpu_system_usage_percent, cpu_iowait_usage_percent, cpu_steal_time_usage_percent)
    sys.exit(1)
else:
    print cmd_options.cpu_name +' STATISTICS OK :cpu=%.2f%% user=%.2f%% system=%.2f%% iowait=%.2f%% steal=%.2f%% | cpu=%.2f%% user=%.2f system=%.2f iowait=%.2f steal=%.2f' % (cpu_usage_percent, cpu_user_usage_percent, cpu_system_usage_percent, cpu_iowait_usage_percent, cpu_steal_time_usage_percent, cpu_usage_percent, cpu_user_usage_percent, cpu_system_usage_percent, cpu_iowait_usage_percent, cpu_steal_time_usage_percent)
    sys.exit(0)
